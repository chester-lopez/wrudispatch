$(document).ready(function() {
	...
	// toggle fullwidth
	$("body").on('click', `.btn-toggle-fullwidth`,function(){
	// $('.btn-toggle-fullwidth').on('click', function() {
		...
		$(this).find('i').toggleClass('la la-arrow-circle-left la la-arrow-circle-right');
	...
	$(window).on('load', function() {
		if($(window).innerWidth() < 1025) {
			...
			.removeClass('la la-arrow-circle-left')
			.addClass('la la-arrow-circle-right');
		}
