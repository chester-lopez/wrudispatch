...
const dispatch = () => {
    return Joi.object().keys({
        ...
        destination: Joi.array().allow('',null),
        ...
        customers: Joi.array().allow('',null),
        support_unit: Joi.string().allow('',null),
        shipment_type: Joi.string().allow('',null),
        delivery_sequence: Joi.string().allow('',null),
        mdsd_usage: Joi.string().allow('',null),
